export const en = {
  ...
  "end call": "The other party has hung up. The call has ended.",
  // 通话提示语
  ...
  "This line is currently busy. Please try again later.": "This line is currently busy. Please try again later."
};