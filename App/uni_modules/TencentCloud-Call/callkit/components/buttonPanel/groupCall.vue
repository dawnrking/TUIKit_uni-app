<template>
  <view class="button-panel-container">
    <view class="button-group" v-if="callRole === CallRole.CALLER || callStatus === CallStatus.CONNECTED">
      <view class="button-group-row">
        <tx-microphone />
        <tx-handsfree :default-open="mediaType === CallMediaType.VIDEO" />
        <tx-camera :default-open="mediaType === CallMediaType.VIDEO" />
      </view>
    ...
    <view class="button-group-bottom" v-if="callStatus === CallStatus.CALLING && callRole === CallRole.CALLEE">
      <reject />
      <accept />
    </view>
  </view>
