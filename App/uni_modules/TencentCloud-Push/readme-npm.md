...
import { registerPush, getRegistrationID, EVENT, addPushListener } from '@/uni_modules/TencentCloud-Push';
...
1. 在 [IM控制台 > 推送服务 Push > 接入设置](https://console.cloud.tencent.com/im/push-plugin-push-identifier) 获取的证书ID。
2. 将证书ID 补充到 `uni_modules/TencentCloud-Push/utssdk/app-harmony/resources/rawfile/timpush-configs.json` 文件中。
